...
class WelcomeBloc extends BaseBloc {
  ...
  void _checkToken(WelcomeEventCheckToken welcomeEventCheckToken, Emitter<BaseState> emitter) {
  ...
  void _triggerLogin(WelcomeEventLogin welcomeEventLogin, Emitter<BaseState> emitter){
    super.preferencesIdApi!.getTelegramService();
  }
}
